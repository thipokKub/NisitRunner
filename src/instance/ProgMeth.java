...
public class ProgMeth extends model.Character{
	...
	public ProgMeth(int x, int y) throws ResourceException {
		super(x, y, new ArrayList<String>() {
			{
				add("resource/character/danger/monster/progmeth/frame0.png");
				add("resource/character/danger/monster/progmeth/frame1.png");
			}});
		frameCounter = 0;
