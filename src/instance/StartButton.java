...
public class StartButton extends model.ButtonImage{
	
	private int frameStart;
	
	public StartButton(int x, int y, int width, int height) {
		
		super(x, y, "resource/button/start_push.png", "resource/button/start_normal.png", "resource/button/start_hold.png", width, height);
		frameStart = -1;
	}
